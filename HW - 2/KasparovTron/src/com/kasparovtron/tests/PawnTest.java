...
public class PawnTest {
	...
	public static void testOneSquereForward() {
		
		System.out.print("Pawn - OneSquereForward  - ");
	...
	public static void testIfMoveOverTwoSquereIsNotPosible() {
		...
		System.out.print("Pawn - testIfMoveOverTwoSquereIsNotPosible  - ");		
